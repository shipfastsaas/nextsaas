        ...
        >
          <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700">
            <div className="relative">
              {/* Accent top border */}
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-primary-rose to-primary-purple"></div>
              ...
              <div className="p-6">
                <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <a href="/privacy" className="text-sm font-medium text-primary-purple hover:text-primary-purple/80 inline-flex items-center">
                      En savoir plus
                  ...
                  <div className="flex gap-3 w-full md:w-auto">
                    ...
                    <button
                      ...
                      className="flex-1 md:flex-initial px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-primary-rose to-primary-purple hover:from-primary-rose/90 hover:to-primary-purple/90 rounded-lg transition-colors shadow-sm"
                    >
                      Accepter
                    </button>
                  </div>
