          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading}
                className="relative w-full rounded-xl bg-gradient-to-r from-primary-purple to-primary-rose py-3.5 px-7 text-center text-sm font-semibold text-white shadow-lg transition-all hover:from-primary-purple/90 hover:to-primary-rose/90 focus:outline-none focus:ring-2 focus:ring-primary-purple/50 disabled:opacity-70 overflow-hidden group"
              >
